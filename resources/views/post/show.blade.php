            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="main_blog_details">
                        <img class="img-fluid" src="{{ str_contains($post->preview_image, 'http') ? $post->preview_image : Storage::url($post->preview_image)}}" alt="">
                    ...
                    <div class="comment-form">
                        ...
                        <form action=" {{ route('posts.comment.store', $post->id) }} ">
                            ...
                            <button href="" class="button submit_btn">Post Comment</button>
                        </form>
                    </div>
                </div>
