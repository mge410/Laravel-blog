                ...
                <div class="owl-carousel owl-theme blog-slider">
                    ...
                    <div class="card blog__slide text-center">
                        <div class="blog__slide__img">
                            <img class="card-img rounded-0" width="350px" height="200px" src="{{ str_contains($post->preview_image, 'http') ? $post->preview_image : Storage::url($post->preview_image)}}" alt="">
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="{{ $mainPost->preview_image }}" alt="">
                                <ul class="thumb-info">
                        ...
                        <div class="widget-wrap">
                            <div class="single-sidebar-widget newsletter-widget">
                                ...
                                <div class="form-group mt-30">
                                    <div class="col-autos">
                                        <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Введите почту" onfocus="this.placeholder = ''"
